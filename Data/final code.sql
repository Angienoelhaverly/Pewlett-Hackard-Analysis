...
LEFT JOIN dep_employees
ON retirement_info.emp_no = dep_employees.emp_no; 
...
-- Join for retirement_info and dept_emp tables
SELECT ri.emp_no,
    ri.first_name,
    ri.last_name,
	de.to_date
